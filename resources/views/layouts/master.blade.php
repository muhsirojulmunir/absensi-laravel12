        ...
        <nav class="flex-1 px-2 space-y-0.5 overflow-y-auto py-1">
            ...
            @if(Auth::user()->role->slug == 'super-admin')
                ...
                <a href="{{ route('super-admin.contracts.index') }}"
                   class="flex items-center rounded-lg transition-all duration-200 {{ request()->routeIs('super-admin.contracts.*') ? 'bg-blue-600 text-white shadow-sm shadow-blue-500/10' : 'text-slate-400 hover:bg-white/5 hover:text-slate-200' }}"
                   :class="collapsed ? 'justify-center px-2 py-2.5' : 'space-x-2.5 px-3 py-2.5'"
                   title="Kontrak Kerja">
                    <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    <span class="text-[13px] font-medium" x-show="!collapsed" x-transition>Kontrak Kerja</span>
                </a>
            ...
            @if(Auth::user()->role->slug == 'hrd')
                ...
                <a href="{{ route('hrd.scanner.index') }}"
                   class="flex items-center rounded-lg transition-all duration-200 {{ request()->routeIs('hrd.scanner.*') ? 'bg-blue-600 text-white shadow-sm shadow-blue-500/10' : 'text-slate-400 hover:bg-white/5 hover:text-slate-200' }}"
                   :class="collapsed ? 'justify-center px-2 py-2.5' : 'space-x-2.5 px-3 py-2.5'"
                   title="Scanner Dokumen">
                    ...
                    <span class="text-[13px] font-medium" x-show="!collapsed" x-transition>Scanner Dokumen</span>
                </a>
            @endif
