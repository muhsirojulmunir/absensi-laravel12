...
<div class="space-y-6" x-data="{ search: '' }">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <a href="{{ route('pic_ramayana.ramayana-stocks.index') }}?date={{ $filterDate }}" class="inline-flex items-center text-sm font-medium text-slate-500 hover:text-blue-600 mb-2 transition-colors">
