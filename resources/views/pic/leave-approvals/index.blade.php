                                ...
                                <a href="{{ asset('storage/' . $leave->photo) }}" target="_blank" rel="noopener"
                                   class="mt-2 inline-block group/foto">
                                    <img src="{{ asset('storage/' . $leave->photo) }}" alt="Foto bukti"
                                         class="w-32 h-24 object-cover rounded-xl border-2 border-slate-200 dark:border-slate-700 group-hover/foto:border-blue-500 transition-colors shadow-sm">
                                    <span class="block mt-1 text-[9px] font-bold uppercase tracking-wider text-blue-500 group-hover/foto:text-blue-600">
                                        📷 Lihat Foto Bukti
                                    </span>
                                </a>
