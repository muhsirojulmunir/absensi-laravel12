...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="flex items-center space-x-3 mb-6">
        ...
        <h2 class="text-2xl font-bold text-slate-800 dark:text-white tracking-tight">Edit Lokasi Counter</h2>
    </div>

    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm overflow-hidden">
        <form action="{{ route('super-admin.locations.update', $location->id) }}" method="POST" class="p-6 md:p-8 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name', $location->name) }}" required class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 p-3 transition-colors">
            ...
            <div>
                ...
                <input type="url" name="google_maps_url" value="{{ old('google_maps_url', $location->google_maps_url) }}" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 p-3 transition-colors">
            ...
            <div class="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="latitude" name="latitude" value="{{ old('latitude', $location->latitude) }}" class="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 p-2.5 transition-colors text-sm">
                    ...
                    <div>
                        ...
                        <input type="text" id="longitude" name="longitude" value="{{ old('longitude', $location->longitude) }}" class="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 p-2.5 transition-colors text-sm">
            ...
            <div>
                ...
                <input type="number" name="radius" value="{{ old('radius', $location->radius) }}" required min="1" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 p-3 transition-colors">
