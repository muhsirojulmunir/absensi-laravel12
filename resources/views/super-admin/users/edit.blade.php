            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div id="location_wrapper" style="display: {{ $user->role->slug === 'karyawan_ramayana' ? 'block' : 'none' }};" class="animate-fade-in">
                            ...
                            <select name="location_id" id="location_id" 
                                ...
                                @foreach($locations as $location)
                                    <option value="{{ $location->id }}" {{ $user->location_id == $location->id ? 'selected' : '' }} class="dark:bg-slate-950">{{ $location->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
